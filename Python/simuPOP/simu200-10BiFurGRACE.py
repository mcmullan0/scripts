#! /usr/bin/python
# This version comes from simu20-10BiFurGRACE.py
...
pop = sim.Population(size=[10], ploidy=2, loci=100, chromNames=['Chr1'], # Find out whether simuPOP 'thinks' all these loci are on the same chromosome
  alleleNames=['A', 'C', 'T', 'G'],
...
pop.evolve(
  ...
  preOps=[
    ...
    sim.SplitSubPops(subPops=0, sizes=[1000]*2, at=1000),
    sim.SplitSubPops(subPops=0, sizes=[400, 600], at=1100),
    sim.SplitSubPops(subPops=2, sizes=[400, 600], at=1200),
    sim.SplitSubPops(subPops=1, sizes=[200, 400], at=1300),
    sim.SplitSubPops(subPops=4, sizes=[200, 400], at=1400),
    sim.SplitSubPops(subPops=3, sizes=[200]*2, at=1500),
    sim.SplitSubPops(subPops=0, sizes=[200]*2, at=1600),
    sim.SplitSubPops(subPops=3, sizes=[200]*2, at=1700),
    sim.SplitSubPops(subPops=8, sizes=[200]*2, at=1800),
...
#    ], begin=1000),
  ...
  postOps=[
    sim.ResizeSubPops(proportions=[200], begin=50, end=50),
    sim.Stat(popSize=True, step=1000),
